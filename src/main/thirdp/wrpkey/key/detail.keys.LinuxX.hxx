...
, std::make_tuple("space", XK_KP_Space)
...
, std::make_tuple("comma", XK_KP_Separator)
, std::make_tuple(",", XK_KP_Separator)
...
, std::make_tuple("delete", XK_KP_Delete)
, std::make_tuple("home", XK_KP_Home)
, std::make_tuple("end", XK_KP_End)
, std::make_tuple("page up", XK_KP_Page_Up)
, std::make_tuple("page down", XK_KP_Page_Down)
, std::make_tuple("up", XK_KP_Up)
, std::make_tuple("left", XK_KP_Left)
, std::make_tuple("down", XK_KP_Down)
, std::make_tuple("right", XK_KP_Right)
};
